...
exports.stripePayment = exports.sendStripePublishableKey = exports.getAllOrders = exports.createOrder = void 0;
...
// new payment
exports.stripePayment = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
