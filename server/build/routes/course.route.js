...
courseRouter.get('/get-courses-content/:id', user_controller_1.updateAccessToken, auth_1.isAuthenticated, course_controller_1.getCourseByUser);
courseRouter.put('/add-question', auth_1.isAuthenticated, user_controller_1.updateAccessToken, course_controller_1.addQuestion);
...
courseRouter.put('/add-reply', user_controller_1.updateAccessToken, auth_1.isAuthenticated, (0, auth_1.authorizeRoles)('admin'), course_controller_1.replyToReview);
courseRouter.get('/get-all-courses', user_controller_1.updateAccessToken, auth_1.isAuthenticated, (0, auth_1.authorizeRoles)('admin'), course_controller_1.getAllCourses);
